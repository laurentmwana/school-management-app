...
import { MoreHorizontal, Eye, Edit, Trash2, Phone, Users, UserCheck } from "lucide-react"
            ...
            {variant === "admin" && (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem asChild>
                    <Link
                      href={`/admin/guardians/${guardian.id}/delete`}
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>
              Genre: {guardian.gender === "M" ? "Masculin" : guardian.gender === "F" ? "Féminin" : "Non spécifié"}
            </span>
          </div>
        ...
        {guardian.students.length > 0 && (
          <div className="space-y-2">
            <h4 className="text-sm font-medium">Étudiants :</h4>
            <div className="space-y-1">
              {guardian.students.slice(0, 3).map((student) => (
                <div key={student.id} className="text-sm text-muted-foreground flex items-center justify-between">
                  <span>
        ...
        <div className="flex items-center justify-between pt-2">
          <div className="text-xs text-muted-foreground">
            Créé le {new Date(guardian.created_at).toLocaleDateString()}
          </div>
